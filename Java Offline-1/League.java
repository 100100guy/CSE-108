public class League {
    ...
    public League() {
        // assume a league can have at most 5 clubs, add code for initialization
        // accordingly
        clubCount = 0;
        matchCount = 0;
        clubs = new Club[5];
        ...
        for (int i = 0; i < clubCount; i++) {
            for (int j = 0; j < clubCount; j++) {
                ...
                if (i != j) {
                    ...
                    // in the first match, club A will play as the home team and in the second
                    // match, as the away team
                }
            }
        }
    }
    ...
    public void showStandings() {
        ...
        // note that, the sequence in which clubs were added to the league, should be
        // unchanged
        // check the given sample output for clarification
        // (carefully observe the output of showStandings() followed by
        // printLeagueInfo() method calls
