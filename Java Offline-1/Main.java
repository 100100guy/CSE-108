...
public class Main {
    ...
    // Write new classes, their member variables and methods following
    // object-oriented approach, if required
...
/*
 * Sample Input - clubCount = 7, leagueCount = 2, clubName = "C1", "C2", "C3"
 * etc., leagueName = "L1", "L2"
 * Sample Output -
 * League : L1
 * Clubs:
 * C1
